...
from app.routers.extract_requirements_document import router as extract_requirements_document_router
...
app.include_router(extract_requirements_document_router)
